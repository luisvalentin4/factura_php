...
class XML
{
    ...
    {
        $this->atributos = array(); //TENEMOS LOS VALORES
        $comprobante = new Comprobante();
        $emisor = Emisor::getInstance();
        $this->rules = $comprobante->getRules();
    }
    ...
    public function setAtribute($attr, $value)
    {
        ...
        $emisor->atributos[$attr] = $value;
    }

    public function setAtributeComprobante($attr, $value)
    {
        echo $attr . ' - ' . $value;
        $comprobante->atributos[$attr] = $value;
    }
  ...
  function getAtributes()
    {
        ...
        foreach ($this->atributos as $key => $value) :
            // en caso que el atributo sea requerido y este tenga una longuitud de cero
